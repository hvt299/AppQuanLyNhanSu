...
import com.example.quanlynhansu.firebase.getAllEmployee
...
@Composable
fun UpdateEmployeeProfileScreen(
    role: String,
    backInfoScreen: () -> Unit,
    ...
    var deleteUserID by remember {
        mutableStateOf("")
    }
    var deleteEmployeeID by remember {
        mutableStateOf("")
    }
    ...
    var checkingDelete by remember {
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                ...
                title = {
                    Text(text = "Danh sách hồ sơ nhân sự", fontSize = 18.sp, color = Color.White)
                },
                navigationIcon = {
                    IconButton(onClick = {
                        backInfoScreen()
        ...
        floatingActionButton = {
            FloatingActionButton(
                onClick = {
                    showUpdateProfileScreen("0", role)
                },
                containerColor = Color(0xFFFD6229),
        ...
        var openDeleteAlertDialog by remember {
            mutableStateOf(false)
        }
            ...
            openDeleteAlertDialog -> {
                AlertDialogComponent(
                    ...
                    onConfirmation = {
                        ...
                        db.collection("User").document(deleteUserID).delete()
                        db.collection("Employee").document(deleteEmployeeID).delete()
                    ...
                    dialogTitle = "Bạn chắc chắn muốn xóa hay không?",
                                ...
                                Card(
                                    ...
                                    Row(
                                        ...
                                        Row(
                                            ...
                                            IconButton(
                                                onClick = {
                                                    showUpdateProfileScreen(item.userID, role)
                                                },
                                                colors = IconButtonDefaults.iconButtonColors(
                                                    containerColor = Color.Transparent
                                                )
...
@Preview
@Composable
private fun UpdateEmployeeProfileScreenPreview() {
